...
const Hourly = ({weatherData}) => {
  ...
  return (
   ...
   <div className="w-full flex flex-row justify-evenly">
    <div className="flex flex-col items-center px-4 py-1 border-r-2 border-[#293245]">
        ...
        <div className="flex flex-col items-center px-4 py-1 md:border-r-2 lg:border-r-2 border-[#293245]">
        ...
        <div className="md:flex md:flex-col lg:flex lg:flex-col hidden items-center px-4 py-1 border-r-2 border-[#293245]">
