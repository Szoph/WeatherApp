...
const Today = ({weatherData, UVIndex}) => {
  ...
  return (
    ...
    <p className="md:text-xl lg:text-xl text-lg font-bold text-center">{sunsetTemp}</p>
      ...
      <div className="flex flex-col pb-3">
        <span className="flex flex-row gap-2 justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-thermometer"><path d="M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z"/></svg>
